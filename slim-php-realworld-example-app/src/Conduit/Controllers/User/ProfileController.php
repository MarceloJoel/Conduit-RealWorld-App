...
class ProfileController
{
    ...
    public function show(Request $request, Response $response, array $args)
    {
        ...
        $profileData = [
            ...
            // Magia de Eloquent: Traemos las habilidades y extraemos solo el texto del campo 'name'
            'skills' => $user->skills->pluck('name'),
            // Traemos languages y extraemos solo el texto del campo 'name'
            'languages' => $user->languages->pluck('name'),
        ];
