...
class User extends Model
{
    ...
    // Añadimos la funcion Skills:
    //User.php ahora sabe que un usuario 'tiene muchas' habilidades (relación 1:N), lo que te permitirá usar $user->skills en el controlador.
    public function skills()
    {
        return $this->hasMany(Skill::class);
    }

    // Aladimos la funcion Lenguaje:
